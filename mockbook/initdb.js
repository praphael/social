...
const initDB = async (reInit, populate)=>{
    ...
    // NOTE: replyid_top_level is the postid of top-level/root post
    //   while replyid is postid of immediate parent
    //   replyid_top_level is useful for getting all replies for a given top-level post
    ...
    await db.sql`CREATE TABLE IF NOT EXISTS posts(
            ...
            body text NOT NULL,
            tm_last_body_edit timestamptz,
            ipaddr inet NOT NULL,
            replyid_top_level bigint DEFAULT 0,
            replyid bigint DEFAULT 0,
            visibility smallint NOT NULL DEFAULT 1,
            score int NOT NULL DEFAULT 0,
            replies int NOT NULL DEFAULT 0,
            replies_top_level integer NOT NULL DEFAULT 0,
            postid bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY)`;
    await db.sql`CREATE INDEX postsindex ON posts (tm, authorid, top_level_replyid)`;
